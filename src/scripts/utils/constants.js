...
export const errorServer = document.querySelector(".error__server");
export const errorServerHeading = document.querySelector(".error__server_heading");
export const errorServerSubHeading = document.querySelector(".error__server_sub-heading");
export const main = document.querySelector(".main");
export const profileAvatarImage = document.querySelector(".profile__avatar_image");
export const profileImageBackground = document.querySelector(".profile__background");
export const profileEditImageButton = document.querySelector(".profile__button_edit-image");
